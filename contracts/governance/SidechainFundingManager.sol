...
contract SidechainFundingManager is Ownable {
    ...
    constructor(string memory _name, IERC20 _piggy) public {
        name = _name;
        piggy = _piggy;
    }
    ...
    function _changeFromSidechainToMainnet(address _user, uint256 _amount) public {
    ...
    //锁定。为了从 主网->侧链
    function _changeFromMainnetToSidechain(address _user, uint256 _amount) public {
